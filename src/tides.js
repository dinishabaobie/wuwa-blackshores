...
const TIDES = [
  {
    ver: '1.0 – 1.4', tag: '瑝珑 · 今州', title: '今州 · 千里卷戎',
    body: ['（剧情解析待写入）'],
  },
  {
    ver: '1.3', tag: '黑海岸', title: '黑海岸登场',
    body: ['（剧情解析待写入）'],
  },
  {
    ver: '2.0 – 2.3', tag: '黎那汐塔', title: '拉古那 · 圣女与黑潮',
    body: ['（剧情解析待写入）'],
  },
  {
    ver: '2.4 – 2.7', tag: '黎那汐塔', title: '七丘 · 利维亚坦收束',
    body: ['（剧情解析待写入）'],
  },
  {
    ver: '2.8', tag: '穗波市', title: '时隙废都',
    body: ['（剧情解析待写入）'],
  },
  {
    ver: '3.0', tag: '拉海洛', title: '罗伊冰原 · 星炬学院',
    body: ['（剧情解析待写入）'],
  },
  {
